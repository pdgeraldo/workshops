...
![](img\confounder1.png){fig-align="center" width=70%}
...
![](img\confounder3.png){fig-align="center" width=70%}
...
![](img\confounder2.png){fig-align="center" width=70%}
...
![](img\mediation1.png){fig-align="center" width=70%}
...
![](img\mediation2.png){fig-align="center" width=70%}
...
![](img\collider1.png){fig-align="center" width=70%}
...
![](img\collider2.png){fig-align="center" width=70%}
...
![](img\collider3.png){fig-align="center" width=70%}
...
:::{.column width=50%}
![](img\intervention1.png){fig-align="center" width=50%}
:::
...
:::{.column width=50%}
![](img\intervention2.png){fig-align="center" width=50%}
:::
...
:::{.column width=50%}
![](img\intervention3.png){fig-align="center" width=50%}
...
:::{.column width=50%}
![](img\intervention4.png){fig-align="center" width=50%}
...
![](img\intervention5.png){fig-align="center" width=50%}
...
\toprule
\textbf{Identification} & & & \textbf{Independence} & \textbf{Parametric} & \\
\textbf{Strategy} & \textbf{Estimand} & \textbf{Graphical Model} & \textbf{Assumptions} & \textbf{Assumptions} & \textbf{Estimator}\\
\midrule
 RCT & $\E[Y_{1i}-Y_{0i}]$ & \includegraphics[width=0.25\textwidth]{img/id_random.pdf} & $Y_d \indep D$ & No & $\hat{\E}[Y|D=1] - \hat{\E}[Y|D=0]$ \\
\bottomrule
\end{tabular}
```
