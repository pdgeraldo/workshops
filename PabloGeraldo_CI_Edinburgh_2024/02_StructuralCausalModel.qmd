...
| Estimand | Graphical model | Independence | Parametric | Estimator |
| -- | -- | -- | -- | -- |
| $\E[Y_{1i}-Y_{0i}]$ | \includegraphics[width=0.25\textwidth]{img/id_random.pdf} | $Y_d \indep D$ | No | $\hat{\E}[Y|D=1] - \hat{\E}[Y|D=0]$ |
| -- | -- | -- | -- | -- |
